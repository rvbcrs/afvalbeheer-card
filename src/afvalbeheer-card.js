...
console.log("Afvalbeheer Card is being loaded...");
...
class AfvalbeheerCard extends LitElement {
  ...
  _formatDate(dateStr) {
    if (!dateStr || dateStr === "Onbekend") return "Onbekend";
  ...
  _getDaysUntil(dateStr) {
    if (!dateStr || dateStr === "Onbekend") return "?";
...
window.customCards.push({
  type: "afvalbeheer-card",
  name: "Afvalbeheer Card",
  description: "A card that displays data from the afvalbeheer integration",
});
